...
Here we have just analysed one possible path sampled from the trajectory. Let's analyse many. We will obtain 1000 sampled paths for each trajectory and obtain a random path parameterised on each of these (here we will permute each sampled path). This will allow us to compare the properties of 1000 sampled paths to the 1000 random paths. 
